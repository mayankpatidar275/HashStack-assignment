...
contract Access {
    ...
    constructor(address[] memory _owners) {
        ...
        minConfirmationsRequired = SafeMath.div(num, 100);
    }
        ...
        notOwnerExistsMod(owner)
    {
        ...
        // update minConfirmationsRequired
        updateMinConfirmationsRequired(owners);
    }
    ...
    function updateMinConfirmationsRequired(address[] memory _owners) internal {
        uint256 num = SafeMath.mul(_owners.length, 60);
        minConfirmationsRequired = SafeMath.div(num, 100);

        emit QuorumUpdate(minConfirmationsRequired);
    }
}